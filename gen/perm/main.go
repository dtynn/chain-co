...
func main() {
	if err := generate("./cli/api", "api", "api", "./cli/api/proxy_gen.go"); err != nil {
...
func generate(path, pkg, outpkg, outfile string) error {
	...
	filter := func(fi fs.FileInfo) bool {
		if strings.HasSuffix(fi.Name(), "_gen.go") || strings.HasSuffix(fi.Name(), "permission.go") {
			return false
		}
		return true
	}
	...
	err = doTemplate(&buf, m, `// Code generated by ./gen/perm. DO NOT EDIT.
...
`)
	...
	return os.WriteFile(outfile, formatted, 0666)
}
